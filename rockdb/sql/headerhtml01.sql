...
PRO <link rel="icon" href="&viconthispage" type="image/x-icon" />
...
PRO </style>
PRO </head>
PRO <! --<h1> <a href="http://xxx/xxw/" target="_blank"><img src="xx.jpg" alt="exx" height="33" width="52" /></a> teste <em>(TESTE)</em>  </h1>
