...
-- SET LONG 20000 LONGCHUNKSIZE 20000 PAGESIZE 14 LINESIZE 1000 FEEDBACK On VERIFY On TRIMSPOOL ON
-- SET TERM On HEA On LIN 32767 NEWP NONE PAGES 14 FEED On ECHO On VER On LONG 32000 LONGC 2000 WRA ON TRIMS ON TRIM ON TI On TIMI On ARRAY 100 NUM 20 SQLBL ON BLO . RECSEP On;
