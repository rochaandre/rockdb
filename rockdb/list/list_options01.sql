...
PRO        data.addColumn('string', 'Comp id');;
PRO        data.addColumn('string', 'Comp Name');;
PRO        data.addColumn('string', 'Version');;
PRO        data.addColumn('string', 'Schema');;
...
PRO        ]);;
PRO
PRO        var table = new google.visualization.Table(document.getElementById('table_divlistoptions01'));
PRO
...
PRO     <div id="table_divlistoptions01" style="width: 900px; height: 550px;"></div>
PRO     <p>&varhtmlspace</p>
PRO   </body>
PRO </html>
