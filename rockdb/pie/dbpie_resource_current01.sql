...
SPO &var_outputfolder/dbpie_resource_current01_&var_namefile
@report/sql/headerdoc.sql &var_outputfolder/dbpie_shared_pool01_&var_namefile "dbpie_shared_pool01_" "" ""
...
SELECT ',[' ||''''|| name||'''' || ','||
       total|| ']'
from (
  select RESOURCE_NAME name,CURRENT_UTILIZATION total,MAX_UTILIZATION,LIMIT_VALUE
...
PRO
PRO         var options = {
PRO           title: 'Resource Current Utilization',
PRO           is3D: true,
PRO         };
PRO
