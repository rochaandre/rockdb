...
SPO &var_outputfolder/dbpie_resource_maxused01_&var_namefile
...
SELECT ',[' ||''''|| name||'''' || ','||
       total|| ']'
from (
  select RESOURCE_NAME name,CURRENT_UTILIZATION ,MAX_UTILIZATION total,LIMIT_VALUE
