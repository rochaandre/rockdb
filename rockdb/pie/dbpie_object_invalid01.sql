DEFINE vhtmlpage='dbpie_object_invalid01_'
DEFINE vtitlethispage='Invalid Objects - internal schemas'
DEFINE viconthispage='invalid.gif'
...
PRO          ['Owner', '&vtitlethispage']

  SELECT ',[' ||''''|| owner||'''' || ','||
       decode(total,0,100)|| ']'
from (
select 'VALID' owner, 0 total from dual
union all
