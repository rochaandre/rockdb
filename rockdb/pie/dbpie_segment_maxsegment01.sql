...
SPO &var_outputfolder/dbpie_segment_maxsegment01_&var_namefile
@rockdb/sql/headerdoc.sql &var_outputfolder/dbpie_segment_maxsegment01_&var_namefile "dbpie_segment_maxsegment01_" "" ""
...
segment_order AS
(
SELECT  DISTINCT owner,SEGMENT_TYPE,   SEGMENT_NAME, trunc(BYTES/1024/1024/1024) GB
 from
 dba_segments
...
SELECT DISTINCT owner||' '||SEGMENT_TYPE segment_name,gb
FROM segment_top
)
