...
SPO &var_outputfolder/dbgauge_opencursors_&var_namefile

@rockdb/sql/headerdoc.sql &var_outputfolder/dbgauge_opencursors&var_namefile "Cursors" "Check open cursors" "" ""
...
SELECT decode(rownum,1,'[',',[') ||
       ...
       ']' output
from (
select b.value , count(*) total
from v$open_cursor a,
v$parameter b
where b.name='open_cursors'
group by b.value
)
/
PRO         ]);;
